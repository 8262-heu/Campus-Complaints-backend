...
public class DepartmentService {
    ...
    public List<Department> getAll() throws Exception {
        try {
            ...
            // If Firestore is unavailable (e.g., no credentials), return sensible defaults
            System.err.println("⚠️ Firestore unavailable, returning default departments: " + e.getMessage());
